...
<body>
  ...
  <div class="hero">
    ...
    <a  class="arrow" href="#a"><img class="down-arrow" src="source/Images/arrow.gif" alt="logo"></a>
  </div>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <div class="intro-right">
                ...
                <p style="text-align:center;">We've a network of over 100+ engineering manufacturers to deliver world class electronics in the domains of Embedded electronics, Consumer, Robotics, Wearables, Wireless, Industrial, IoT and AI</p>
              </div>
            </div>
          </div>
    ...
    <div class="development-images">
      <div class="development-images-group">
        ...
        <div class="development-hover">
          ...
          <a class="btn btn-primary view-more" href="electronics.php" role="button">View More</a>
        </div>
      </div>
      <div class="development-images-group">
        ...
        <div class="development-hover">
          <p>MECHANICAL</p>
          <a class="btn btn-primary view-more" href="mechanical.php" role="button">View More</a>
        </div>
      </div>
      <div class="development-images-group">
        ...
        <div class="development-hover">
          <p>SOFTWARE</p>
          <a class="btn btn-primary view-more" href="software.php" role="button">View More</a>
        </div>
      </div>
    </div>
    </div>
